...
class Body6 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['contact_json'] = isset($data['contact_json']) ? $data['contact_json'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['contact_json'] === null) {
            $invalidProperties[] = "'contact_json' can't be null";
        }
    ...
    {
        return $this->container['contact_json'];
    }

    /**
     * Sets contact_json
     *
     * @param string $contact_json `{ \"contactId\": \"string\" }`
     *
     * @return $this
     */
    public function setContactJson($contact_json)
    {
        $this->container['contact_json'] = $contact_json;
